...
// ------------------------- MÉTODOS DE PAGO -------------------------
// 🚨 CORRECCIÓN CLAVE: De 'payment-methods' a 'metodos'
router.get('/metodos', pagosController.getAllPaymentMethods); 
router.get('/metodos/:id', pagosController.getPaymentMethodById);
...
router.post('/transaccion-completa', authorizeRoles([1, 2, 3, 5]), pagosController.registrarTransaccionCompleta);
