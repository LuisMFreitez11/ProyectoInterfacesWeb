...
// ⚠️ Importamos el controlador de tickets
const ticketController = require('../controllers/ticketController'); 


// ==================== RUTAS DE VALIDACIÓN DE TICKETS (QR) ====================

// RUTA 1: Obtener detalles del ticket (Vista previa del cliente/solo lectura)
// Endpoint: /api/tickets/details?qr_token=... (Usado por TicketViewer.vue)
router.get('/details', ticketController.getTicketDetailsByQrToken); 

// RUTA 2: Validar y Marcar como Usado (Control de Acceso)
// Endpoint: /api/tickets/validar-qr
router.post('/validar-qr', ticketController.validateAndUseTicket);
