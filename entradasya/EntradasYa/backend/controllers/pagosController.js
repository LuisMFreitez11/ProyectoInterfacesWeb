...
const getAllPayments = async (req, res) => {
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al obtener pagos', error: error.message });
    }
};
...
const getPaymentById = async (req, res) => {
    ...
    try {
        ...
        payment.id_metodo_pago = payment.id_metodo;
        ...
        return res.status(500).json({ ok: false, message: 'Error al obtener pago', error: error.message });
    }
};
    ...
    try {
        ...
        const [result] = await db.execute(
            `INSERT INTO pagos 
             ...
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())`,
            [id_compra || null, id_usuario, id_metodo_pago, monto, moneda_codigo, 
             simbolo_moneda, referencia || null, estadoDb, comision]
        );
        ...
        return res.status(500).json({ ok: false, message: 'Error al crear pago', error: error.message });
    }
};
...
const updatePayment = async (req, res) => {
    ...
    try {
        const allowedFields = ['estado', 'monto', 'referencia', 'id_metodo_pago', 'comision'];
        const setClauses = [];
        const values = [];
        ...
        return res.status(500).json({ ok: false, message: 'Error al actualizar pago', error: error.message });
    }
};
...
const deletePayment = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al eliminar pago', error: error.message });
    }
};
...
const getAllExpenses = async (req, res) => {
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al obtener gastos', error: error.message });
    }
};
...
const getExpenseById = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al obtener gasto', error: error.message });
    }
};
    ...
    try {
        ...
        const [result] = await db.execute(
            `INSERT INTO gastos 
             ...
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [id_evento || null, id_categoria, descripcion, fecha_gasto, monto, moneda_codigo,
             simbolo_moneda, receptor || null, referencia_pago || null, 
             comprobante_url || null, registrado_por || null]
        );
        ...
        return res.status(500).json({ ok: false, message: 'Error al crear gasto', error: error.message });
    }
};
...
const updateExpense = async (req, res) => {
    ...
    try {
        const allowedFields = ['id_evento', 'id_categoria', 'descripcion', 'fecha_gasto', 
                              'monto', 'receptor', 'referencia_pago', 'comprobante_url'];
        const setClauses = [];
        const values = [];
        ...
        return res.status(500).json({ ok: false, message: 'Error al actualizar gasto', error: error.message });
    }
};
...
const deleteExpense = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al eliminar gasto', error: error.message });
    }
};
...
const getAllPaymentMethods = async (req, res) => {
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al obtener métodos de pago', error: error.message });
    }
};
...
const getPaymentMethodById = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al obtener método de pago', error: error.message });
    }
};
...
const createPaymentMethod = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al crear método de pago', error: error.message });
    }
};
...
const updatePaymentMethod = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al actualizar método de pago', error: error.message });
    }
};
...
const deletePaymentMethod = async (req, res) => {
    ...
    try {
        ...
        const [result] = await db.execute('DELETE FROM metodospago WHERE id_metodo = ?', [id]);

        if (result.affectedRows === 0) {
            return res.status(404).json({ ok: false, message: 'Método de pago no encontrado' });
        }

        return res.json({ ok: true, message: 'Método de pago eliminado correctamente' });
    } catch (error) {
        console.error('deletePaymentMethod error:', error);
        return res.status(500).json({ ok: false, message: 'Error al eliminar método de pago', error: error.message });
    }
};
...
const getAllExpenseCategories = async (req, res) => {
    try {
        ...
        return res.status(500).json({ ok: false, message: 'Error al obtener categorías', error: error.message });
    }
};
...
const registrarTransaccionCompleta = async (req, res) => {
    ...
    try {
        ...
        if (items_ticket.length > 0) {
            for (const item of items_ticket) {
                const qr_token = generarQRToken(id_pago, item.index || 1);
